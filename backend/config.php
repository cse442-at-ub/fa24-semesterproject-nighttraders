...
// define('FRONTEND_URL', 'https://se-dev.cse.buffalo.edu/CSE442/2024-Fall/paridhik/');
// define('BACKEND_URL', 'https://se-dev.cse.buffalo.edu/CSE442/2024-Fall/paridhik/backend');

// // Database configuration
// define('API_KEY', 'OC18QBU4BLSDMQKA');
// define('SERVER_NAME', 'localhost');
// define('DB_USER', 'paridhik');
// define('DB_PASS', '50496901');
// define('DB_NAME', 'paridhik_db');
